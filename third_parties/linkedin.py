...
def scrape_linkedin_profile(linkedin_profile_url: str, mock: bool = False):
  ...
  # clean data to reduce token usage 
  data = response.json()
...
if __name__ == "__main__":
  print(scrape_linkedin_profile(linkedin_profile_url="https://www.linkedin.com/in/owenwang05/", mock=True))
